! function(a, b, c) {
    ...
    a.DLMenu = function(b, c) {
        ...
        _config: function() {
		 ...
		 this.open = !1, this.$menuwrapper = a("#dl-menu"), this.$trigger = this.$el.children(".dl-trigger"), this.$menu = this.$el.children("ul.dl-menu"), this.$menuitems = this.$menu.find("li:not(.dl-back)"), this.$el.find("ul.dl-submenu").prepend('<li class="dl-back"><a href="#">back</a></li>'), this.$back = this.$menu.find("li.dl-back")
        },
        _initEvents: function() {
            ...
            }), this.$menuitems.on("click.dlmenu", function(f) {
                f.stopPropagation();
                var g = a(this),
                    h = g.children("ul.dl-submenu");
                if (h.length > 0) {
                    var i = h.clone().css({
                            opacity: 0,
                            margin: 0,
                        ...
                        j = function() {
                            b.$menu.off(b.animEndEventName).removeClass(b.options.animationClasses.classout).addClass("dl-subview"), g.addClass("dl-subviewopen").parents(".dl-subviewopen:first").removeClass("dl-subviewopen").addClass("dl-subview"), i.remove()
                        };
                    return setTimeout(function() {
                        i.addClass(b.options.animationClasses.classin), b.$menu.addClass(b.options.animationClasses.classout), b.supportAnimations ? b.$menu.on(b.animEndEventName, j) : j.call(), b.options.onLevelClick(g, g.children("a:first").text())
                    }), !1
                }
                b.options.onLinkClick(g, f)
            }), this.$back.on("click.dlmenu", function(f) {
                var g = a(this),
                    h = g.parents("ul.dl-submenu:first"),
                    i = h.parent(),
                    j = h.clone().css({
                        position: c,
                        top: d,
                    ...
                    k = function() {
                        b.$menu.off(b.animEndEventName).removeClass(b.options.animationClasses.classin), j.remove()
                    };
                return setTimeout(function() {
                    j.addClass(b.options.animationClasses.classout), b.$menu.addClass(b.options.animationClasses.classin), b.supportAnimations ? b.$menu.on(b.animEndEventName, k) : k.call(), i.removeClass("dl-subviewopen");
                    var a = g.parents(".dl-subview:first");
        ...
        _closeMenu: function() {
            ...
            //this.$menuwrapper.removeClass("dl-menuopen"), this.$menu.removeClass("dl-menuopen"), this.$menu.addClass("dl-menu-toggle"), this.$trigger.removeClass("dl-active"), this.supportTransitions ? this.$menu.on(this.transEndEventName, b) : b.call(), this.open = !1
        },
...
function(a) {
...
}(window.jQuery || window.Zepto), window.matchMedia = window.matchMedia || function(a, b) {
        "use strict";
    ...
    function(a) {
        ...
        $(".image-popup").magnificPopup({
            ...
            removalDelay: 300,
            mainClass: "mfp-fade"
        }), $("#scrollup").css("position", "fixed"), $("#scrollup").css("bottom", "0px"), $("#scrollup").css("right", "20px"), $(window).scroll(function() {
            $(this).scrollTop() > 500 ? $("#scrollup").fadeIn() : $("#scrollup").fadeOut()
